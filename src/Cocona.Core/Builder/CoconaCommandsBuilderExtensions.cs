...
public static class CoconaCommandsBuilderExtensions
{
    ...
    extension(ICoconaCommandsBuilder builder)
    {
        private IList<object> GetFilters()
        {
        ...
        /// <returns></returns>
        public ICoconaCommandsBuilder UseFilter(IFilterMetadata filter)
        {
        ...
        /// <returns></returns>
        public ICoconaCommandsBuilder UseFilter(IFilterFactory filterFactory)
        {
        ...
        /// <returns></returns>
        public ICoconaCommandsBuilder UseFilter(Func<CoconaCommandExecutingContext, CommandExecutionDelegate, ValueTask<int>> filterFunc)
        {
        ...
        /// <returns></returns>
        public ICoconaCommandsBuilder AddCommand(ICommandData commandData)
        {
        ...
        /// <returns></returns>
        public CommandConventionBuilder AddCommand(Delegate commandBody)
        {
        ...
        /// <param name="commandBody"></param>
        /// <returns></returns>
        public CommandConventionBuilder AddCommand(string name, Delegate commandBody)
        {
        ...
        /// <returns></returns>
        public CommandConventionBuilder AddSubCommand(string name, Action<ICoconaCommandsBuilder> configure)
        {
            ThrowHelper.ThrowIfNull(name);
        ...
        /// </summary>
        /// <returns></returns>
        public CommandTypeConventionBuilder AddCommands<T>()
        ...
        /// <returns></returns>
        public CommandTypeConventionBuilder AddCommands(Type commandType)
        {
        ...
        /// <returns></returns>
        public ICoconaCommandsBuilder AddCommands(IEnumerable<Type> commandTypes)
        {
