...
/// </summary>
public sealed partial class ZshCoconaShellCompletionCodeGenerator : ICoconaShellCompletionCodeGenerator
{
    ...
    private static string GetOptions(ICommandOptionDescriptor option, ICommandOptionDescriptor? helpOption)
    {
        ...
        {
            if (helpOption.ShortName is {Count: > 0})
            {
        ...
        if (option.ShortName is {Count: > 0})
        {
